...
abstract class AbsAlipayTradeService extends AbsAlipayService implements AlipayTradeService {
    ...
    @Override
    public AlipayF2FPrecreateResult tradePagePrecreate(AlipayTradePrecreateRequestBuilder builder) {
        validateBuilder(builder);
        ...
        AlipayTradePrecreateResponse response = (AlipayTradePrecreateResponse) getPageResponse(client, request);
