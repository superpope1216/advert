...
(function($){
    $.fn.ajaxImageUpload = function(options){
        ...
        var uploadBox = $("#"+config.id);
        var imageBox  = $("#"+config.id+" .image-box");
        ...
        var handleFileSelect = function(){
            ...
            // 获取最新的section数量
            var imageNum  = $('#'+config.id+'.image-section').length;
        ...
        var ajaxUpload = function () {
            ...
            // 获取最新的
            var imageSection = $('#'+config.id+' .image-section:first');
            var imageShow    = $('#'+config.id+' .image-show:first');
           ...
           // deleteModal.appendTo('.image-box');
            ...
            imageBox.delegate(".image-delete","click",function(){
            	...
            	confirm("确认删除该图片吗？",function(){
            		...
            		doPost(basePath+"/attr/remove","wid="+config.wid,function(){
            			deleteImageSection.remove();
            			$("#"+config.id+" .upload-section").show();
            ...
            // 确认删除
            $("#"+config.id+" .confirm-btn").click(function(){
            ...
            // 取消删除
            $("#"+config.id+" .cancel-btn").click(function(){
                deleteModal.hide();
            });
        ...
        var createImageSection = function () {
            ...
            var imgNum=$('#'+config.id+' .image-section').length;
            if(imgNum>=config.maxNum){
            	$("#"+config.id+" .upload-section").hide();
            }
            ...
            if(config.wid){
            	 imageSection.removeClass("image-loading");
                 imageShow.removeClass("image-opcity");
            	imageShow.attr("src",basePath+"/image/preView?wid="+config.wid)
            }
            return imageSection;
