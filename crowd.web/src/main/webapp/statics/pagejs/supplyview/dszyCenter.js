...
//					}
					...
					html+='				<a href="'+basePath+'/supplyDszyDetail/index?wid='+_data.wid+'" target="_blank">';
					...
					html+='					<a href="'+basePath+'/supplyDszyDetail/index?wid='+_data.wid+'&ggxs='+_data.advert_type+'" target="_blank"	class="info-body-title-name">';
