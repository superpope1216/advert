...
$(document).ready(function(){
	...
	*/
	...
	$("#ddArea a").click(function(){
		...
		doGet(basePath+"/dictionary/selectGbdst","areaBm="+_areaBm,function(data){
			if(data && data.datas){
				var html="";
	...
	function queryRwjbxx(param){
		doGet(basePath+"/supplyGbzyCenter/list",param,function(data){
			var html="";
			if(data && data.datas){
...
//					}
					...
					html+='				<a href="'+basePath+'/supplyGbzyDetail/index?wid='+_data.wid+'" target="_blank">';
					...
					html+='					<a href="'+basePath+'/supplyGbzyDetail/index?wid='+_data.wid+'&ggxs='+_data.advert_type+'" target="_blank"	class="info-body-title-name">';
