...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/supplyZzzyCenter/index" title="杂志广告">杂志广告</a></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<script
		src="<%=request.getContextPath()%>/statics/pagejs/supplyview/detail/zzzyDetail.js"></script>
</body>
</html>
