...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/supplyBzzyCenter/index" title="报纸广告">报纸广告</a></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<script
		src="<%=request.getContextPath()%>/statics/pagejs/supplyview/detail/bzzyDetail.js"></script>
</body>
</html>
