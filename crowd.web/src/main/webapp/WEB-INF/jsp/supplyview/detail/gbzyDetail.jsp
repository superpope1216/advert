...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/supplyGbzyCenter/index" title="广播广告">广播广告</a></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<script
		src="<%=request.getContextPath()%>/statics/pagejs/supplyview/detail/gbzyDetail.js"></script>
</body>
</html>
