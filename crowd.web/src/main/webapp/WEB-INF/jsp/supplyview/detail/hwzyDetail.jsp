...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/supplyHwzyCenter/index" title="户外广告">户外广告</a></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<script
		src="<%=request.getContextPath()%>/statics/pagejs/supplyview/detail/hwzyDetail.js"></script>
</body>
</html>
