...
<![endif]-->
										...
										<div class="container padding-bottom-10">
											...
											<dl id="dlArea" style="display: none;">
												...
												<dd id='ddArea'>
													<span style="width: 180px"><a
														class="btn queryActive link" href="javascript:void(0);"
														data-option="area" title="全部" data-key="">全部</a></span>
	...
	<script
		src="<%=request.getContextPath()%>/statics/pagejs/supplyview/hwzyCenter.js"></script>
</body>
</html>
