						...
						<div class="panel-body shop-order">
							<div>
								<ul class="nav nav-tabs nav-tabs-line m-b-0 shop-order-state">
								  <li class='nav-item'><a id="aCard" class="nav-link active" data-toggle="tab"
										href="#state0" data-state="0">身份信息</a></li>
									<li class='nav-item' ><a id="aBasic" class="nav-link"
							...
							<ul
								...
								<form class="form-horizontal" role="form" id="formCardInfo">
									<%@include file="/jsp/kfzxx/basic/cardInfo.jsp"%>
						  ...
						  <ul
								...
								<form class="form-horizontal" role="form" id="formBasicInfo">
									<%@include file="/jsp/kfzxx/basic/basicInfo.jsp"%>
									<div class="row" style="border-bottom: none;">
										<div class="col-xs-3 "></div>
										<div class="col-xs-9">
							...
							<ul
								...
								<form class="form-horizontal" role="form" id="formResumeInfo">
									<%@include file="/jsp/kfzxx/basic/kfzResumeInfo.jsp"%>
									<div class="row" style="border-bottom: none;">
										<div class="col-xs-3 "></div>
										<div class="col-xs-9">
											<button class="btn btn-primary mybtn" type="button" id="saveResumeInfo">保存</button>
										</div>
									</div>
								</form>
