						...
						<div class="panel-body shop-order">
							...
							<ul
								...
								<form class="form-horizontal" role="form" id="formBasicInfo">
									<%@include file="/jsp/kfzxx/first/basicInfo.jsp"%>
							...
							<ul
								...
								<form class="form-horizontal" role="form" id="formResumeInfo">
									<%@include file="/jsp/kfzxx/first/kfzResumeInfo.jsp"%>
									<div class="row" style="border-bottom: none;">
										<div class="col-xs-3 "></div>
										<div class="col-xs-9">
							...
							<ul
								...
								<form class="form-horizontal" role="form" id="formCardInfo">
									<%@include file="/jsp/kfzxx/first/cardInfo.jsp"%>
									<div class="row" style="border-bottom: none;">
										<div class="col-xs-3 "></div>
										<div class="col-xs-9">
											<button class="btn btn-primary mybtn" type="button"  id="saveKfzxxInfo">提交审核</button>
										</div>
									</div>
								</form>
