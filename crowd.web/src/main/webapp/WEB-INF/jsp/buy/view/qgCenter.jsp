...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/qgCenter/index" title="求购信息">求购信息</a></li>
				</ol>
			</div>
		</div>
	</div>
 ...
 -->
			<div class="col-xs-3" style="margin-top: 20px; padding-top: 10px; padding-bottom: 10px;">
				<div class="panel m-b-0" boxmh-mh>
					<div class="panel-body shop-order">
						...
						<div class="center-right-body">
							<div>
								<ul>
									<li><b><i>1</i></b> <!-- react-text: 358 -->注册账号<!-- /react-text --></li>
									<li><b><i>2</i></b> <!-- react-text: 362 -->申请为广告求购方<!-- /react-text --></li>
									<li><b><i>3</i></b> <!-- react-text: 366 -->平台审核身份<!-- /react-text --></li>
									<li><b><i>4</i></b> <!-- react-text: 370 -->发布求购信息<!-- /react-text --></li>
									<li><b><i>5</i></b> <!-- react-text: 370 -->平台审核求购信息<!-- /react-text --></li>
									<li><b><i>6</i></b> <!-- react-text: 370 -->求购信息进入大厅<!-- /react-text --></li>
								</ul>
								<a href="<%=request.getContextPath()%>/buyQgPublishing/index"><button
										class="button-3791w publish-2ReEl block-1WyYE primary-32yiR">立即发布求购信息</button></a>
							</div>
						</div>
					</div>
				</div>
		...
		<script
			src="<%=request.getContextPath()%>/statics/pagejs/buy/view/qgCenter.js"></script>
</body>
</html>
