							...
							<div class="row"  style="margin-top:20px;">
								<form class="form-register met-form form-horizontal"
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">代理标题</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">代理开始时间</label>
										<div class="col-sm-10">
											<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">代理内容正文</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">代理主题简介</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
