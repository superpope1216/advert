							...
							<div class="row"  style="margin-top:20px;">
								<form class="form-register met-form form-horizontal"
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作标题</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
												<input type="text" class="form-control" name="title"
													placeholder="请输入合作信息标题"
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作开始时间</label>
										<div class="col-sm-10">
											<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作内容正文</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作主题简介</label>
										<div class="col-sm-10">
											<div class="col-sm-10">
												<textarea class="form-control" cols="8" name="ztnr" placeholder="请输入合作主题简介"
