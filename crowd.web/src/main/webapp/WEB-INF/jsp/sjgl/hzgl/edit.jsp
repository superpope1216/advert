							...
							<div class="row"  style="margin-top:20px;">
								<form class="form-register met-form form-horizontal"
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作标题<span
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作开始时间<span
											style="color: red">*</span></label>
										<div class="col-sm-10">
											<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作内容正文<span
											style="color: red">*</span></label>
										<div class="col-sm-10">
											<div class="col-sm-10">
									...
									<div class="form-group">
										<label for="firstname" class="col-sm-2 control-label">合作主题简介<span
											style="color: red">*</span></label>
										<div class="col-sm-10">
											<div class="col-sm-10">
