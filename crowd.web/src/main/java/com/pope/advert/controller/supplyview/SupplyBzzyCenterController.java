...
@Controller
@RequestMapping("supplyBzzyCenter")
public class SupplyBzzyCenterController extends BaseController{
	@Autowired
	...
	public ModelAndView index(String flag,String queryGgxs) throws Exception{
		...
		mv.setViewName("supplyview/bzzyCenter");
		...
		mv.addObject("ggxs", dictionaryService.selectByCondtion(DictionaryEnum.T_ADVERT_SJZD_BZLX, null));
		return mv;
	}
