...
@Controller
@RequestMapping("supplyGbzyCenter")
public class SupplyGbzyCenterController extends BaseController{
	@Autowired
	...
	public ModelAndView index(String flag,String queryGgxs) throws Exception{
		...
		mv.setViewName("supplyview/gbzyCenter");
		...
		mv.addObject("ggxs", dictionaryService.selectByCondtion(DictionaryEnum.T_ADVERT_SJZD_GBLX, null));
		return mv;
	}
	...
	public DataResult<List<Map<String,Object>>> list(String ggxs,String areaBm,String cityBm,String dst,Integer pageSize,Integer pageNum) throws Exception{
		...
		querySupplyInfo.setGglx(SupplyClassifyEnum.GBGG.getCode());
