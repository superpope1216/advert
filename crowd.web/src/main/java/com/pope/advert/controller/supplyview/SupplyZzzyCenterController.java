...
@Controller
@RequestMapping("supplyZzzyCenter")
public class SupplyZzzyCenterController extends BaseController{
	@Autowired
	...
	public ModelAndView index(String flag) throws Exception{
		...
		mv.setViewName("supplyview/zzzyCenter");
		...
		mv.addObject("ggxs", dictionaryService.selectByCondtion(DictionaryEnum.T_ADVERT_SJZD_ZZZYLX, null));
		return mv;
	}
	...
	public DataResult<List<Map<String,Object>>> list(String ggxs,String areaBm,String cityBm,String dst,Integer pageSize,Integer pageNum) throws Exception{
		...
		querySupplyInfo.setGglx(SupplyClassifyEnum.BZGG.getCode());
