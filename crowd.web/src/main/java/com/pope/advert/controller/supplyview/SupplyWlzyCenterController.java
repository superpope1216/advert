...
public class SupplyWlzyCenterController extends BaseController{
	...
	public ModelAndView index(String flag,String queryGgxs) throws Exception{
		...
		mv.setViewName("supplyview/wlzyCenter");
		...
		mv.addObject("ggxs", dictionaryService.selectByCondtion(DictionaryEnum.T_ADVERT_SJZD_WLGZWZ, null));
		return mv;
	}
	...
	public DataResult<List<Map<String,Object>>> list(String ggxs,String areaBm,String cityBm,String dst,Integer pageSize,Integer pageNum) throws Exception{
		...
		querySupplyInfo.setGglx(SupplyClassifyEnum.WLGG.getCode());
