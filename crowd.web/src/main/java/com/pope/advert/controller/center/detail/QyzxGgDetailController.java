...
@Controller
@RequestMapping("qyzxGgDetail")
public class QyzxGgDetailController extends BaseController{
	@Autowired
	...
	public ModelAndView index(String wid, String sjlx) throws Exception {
		...
		mv.setViewName("center/detail/qyzxGgDetail");
		return mv;
	}
	...
	public DataResult<QyzxGgInfoExtend> select(String wid) throws Exception {
		...
		List<QyzxGgInfoExtend> datas = qyzxGgInfoService.selectDisplayByCondition(
	...
	public DataResult<CompanyInfoExtend> selectCompanyInfo(String wid, String sjlx) throws Exception {
		QyzxGgInfo qyzxNewsInfo = qyzxGgInfoService.selectByPrimaryKey(wid, this.createCustomOperateLog())
				.getDatas();
