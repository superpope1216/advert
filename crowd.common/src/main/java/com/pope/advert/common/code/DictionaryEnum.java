...
public enum DictionaryEnum {
	...
	T_ADVERT_SJZD_SF("T_ADVERT_SJZD_SF","是否"),
	T_ADAVERT_SJZD_WLZY_XT("T_ADAVERT_SJZD_WLZY_XT","网络资源形态"),
	T_ADAVERT_SJZD_WLZY_FS("T_ADAVERT_SJZD_WLZY_FS","网络资源方式"),
	T_ADAVERT_SJZD_WLZY_CC("T_ADAVERT_SJZD_WLZY_CC","网络资源尺寸"),
	T_ADAVERT_SJZD_WLZY_JFFS("T_ADAVERT_SJZD_WLZY_JFFS","网络资源计费方式"),
	
	T_ADVERT_SJZD_HWZY_LX("T_ADVERT_SJZD_HWZY_LX","户外资源类型"),
	T_ADVERT_SJZD_HWZY_XX("T_ADVERT_SJZD_HWZY_XX","户外资源信息"),
	T_ADVERT_SJZD_HWZY_QY("T_ADVERT_SJZD_HWZY_QY","户外资源区域"),
	T_ADVERT_SJZD_HWZY_XS("T_ADVERT_SJZD_HWZY_XS","户外资源形式"),
	T_ADVERT_SJZD_HWZY_MEZT("T_ADVERT_SJZD_HWZY_MEZT","户外资源媒体状态"),
	T_ADVERT_SJZD_HWZY_ZXTFZQ("T_ADVERT_SJZD_HWZY_ZXTFZQ","户外资源最小投放周期"),
	T_ADVERT_SJZD_HWZY_GGSYQZT("T_ADVERT_SJZD_HWZY_GGSYQZT","户外资源广告所有权状况"),
	T_ADVERT_SJZD_HWZY_ZMSJ("T_ADVERT_SJZD_HWZY_ZMSJ","户外资源照明时间"),
	T_ADVERT_SJZD_CWGL_CZZT("T_ADVERT_SJZD_CWGL_CZZT","结算充值状态"),
	T_ADVERT_SJZD_YHGL_HYZT("T_ADVERT_SJZD_YHGL_HYZT","会员状态");
